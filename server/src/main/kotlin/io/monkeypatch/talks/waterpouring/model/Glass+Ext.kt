 ...
 */
fun Glass.isEmpty(): Boolean= current == 0
 ...
 */
fun Glass.isFull(): Boolean = current == capacity
 ...
 */
fun Glass.remainingVolume(): Int = capacity - current
 ...
 */
fun Glass.empty(): Glass = copy(current = 0)
 ...
 */
fun Glass.fill(): Glass = copy(current = capacity)
